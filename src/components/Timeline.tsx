...
export function Timeline() {
  return (
    <motion.div 
      ...
      className="bg-white border-t border-black/10 px-6 py-4 flex flex-col gap-3 relative z-10 shadow-[0_-10px_30px_rgba(0,0,0,0.02)]"
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 text-brand-olive font-bold text-sm">
          <Clock size={16} />
